...
<Toolbar className="header_toolbar">
  <Box className="header_leftSection">
    <img src={logo} alt="Logo" className="header_logo" />

    <Box className="header_navLinks">
      <Typography
        onClick={() => navigate("/dashboard")}
        className={`header_navLink ${isActive("/dashboard") ? "header_active" : ""}`}
      >
        Home
      </Typography>
      <Typography className="header_navLink header_disabled">Tools</Typography>
      <Typography className="header_navLink header_disabled">Service</Typography>
    </Box>
  </Box>

        <Box className="header_rightSection">
          <IconButton disableRipple>
            <Badge variant="dot" color="error" overlap="circular" className="header_badge">
              <img src={notificationBell} alt="Notifications" className="header_icon" />
            </Badge>
          </IconButton>

          <Divider orientation="vertical" flexItem sx={{ mx: 0, height: 28, borderColor: "#ccc",marginTop:"10px" }} />

          <IconButton disableRipple onClick={handleMenuOpen}>
            <Avatar src={profilePic} className="header_avatar" />
          </IconButton>
          ...
          <Menu
            ...
            PaperProps={{ className: "header_menuPaper" }}
          >
